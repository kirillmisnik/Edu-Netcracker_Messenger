DROP SEQUENCE chats_id_seq CASCADE;
DROP SEQUENCE users_id_seq CASCADE;
DROP SEQUENCE chat_members_id_seq CASCADE;
DROP SEQUENCE messages_id_seq CASCADE;
...
(
    id BIGINT NOT NULL DEFAULT nextval('chat_members_id_seq'),
