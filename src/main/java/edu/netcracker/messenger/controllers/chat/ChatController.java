package edu.netcracker.messenger.controllers.chat;

import edu.netcracker.messenger.models.chat.*;
...
import edu.netcracker.messenger.views.chat.ChatBodyView;
import edu.netcracker.messenger.models.message.Message;
import edu.netcracker.messenger.models.message.MessageRepository;
import edu.netcracker.messenger.views.chat.ChatView;
import edu.netcracker.messenger.views.message.MessageBody;
...
public class ChatController {
    ...
    @PostMapping("/{chatId}")
    public @ResponseBody
    Long sendMessage(Principal principal, @PathVariable Long chatId, @RequestBody MessageBody messageBody) {
        throwIfChatHasErrors(principal, chatId);
